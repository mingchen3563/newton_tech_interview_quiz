...
void main() {
  ...
  group('test get launches', () {
    test('test get launches with status code 200', () async {
      ...
      expect(response, isA<List<LaunchesDto>>());
      expect(response.length, 1);
      expect(response[0].flightNumber, 110);
      expect(response[0].missionName, 'CRS-21');
      expect(response[0].launchYear, '2020');
      expect(response[0].launchDateUnix, 1607271420);
      expect(response[0].launchDateUtc, '2020-12-06T16:17:00.000Z');
